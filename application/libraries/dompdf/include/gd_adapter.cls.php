...
class GD_Adapter implements Canvas
{
	 ...
	 */
	function __construct($size, $orientation = "portrait", DOMPDF $dompdf, $aa_factor = 1.0, $bg_color = array(
		1,
		1,
		1,
		0
	...
	private function _allocate_color($color)
	{
		...
		if ($a != 0)
			$this->_colors[$key] = imagecolorallocatealpha($this->_img, $r, $g, $b, $a); else
	...
	function polygon($points, $color, $width = null, $style = null, $fill = false)
	{
		...
		imagesetthickness($this->_img, $width);
		if ($fill)
			imagefilledpolygon($this->_img, $points, count($points) / 2, $c); else
	...
	function circle($x, $y, $r, $color, $width = null, $style = null, $fill = false)
	{
		...
		imagesetthickness($this->_img, $width);
		if ($fill)
			imagefilledellipse($this->_img, $x, $y, $r, $r, $c); else
	 ...
	 * @return void
	 */
	function text($x, $y, $text, $font, $size, $color = array(
		0,
		0,
		0
