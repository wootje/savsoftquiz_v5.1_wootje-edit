...
if ($this->uri->segment(3) != 'ph') {
	...
	if ($during_quiz != "") {
		...
		<div style="display:none;width:100%;height:90%;background:#212121;position:fixed;z-index:1700;top:0px;right:0px;padding-top:10%;opacity:0.7" id="advertisement_bg"></div>
		<div style="display:none;width:100%;height:90%;background:transparent;position:fixed;z-index:1800;top:0px;right:0px;padding-top:10%;color:#ffffff;" id="advertisement">
			<center>
				<label>Advertisement will close in <?php
					echo $this->config->item('showadvertisement_sec'); ?> Seconds...</label>
				<?php
				echo $during_quiz; ?></center>
		</div>
		<?php
	}
	?>
