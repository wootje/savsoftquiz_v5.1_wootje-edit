						...
						<div class="option_container">
							...
							if ($question['question_type'] == $this->lang->line('multiple_choice_single_answer')) {
								...
								foreach ($options as $ok => $option) {
									if ($option['qid'] == $question['qid']) {
										?>
										<div class="op <?php
										if ($option['score'] >= 0.1) { ?> green_option<?php
											echo $qk; ?><?php
										} ?>">
											<table>
												<tr>
													<td>
														...
														echo $qk; ?>][]" onClick="showan(this.value);" id="answer_value<?php
														echo $qk . '-' . $i; ?>" value="<?php
														echo $option['oid']; ?>" <?php
							...
							if ($question['question_type'] == $this->lang->line('short_answer')) {
								...
								<div class="op">
									...
									echo $qk; ?>" onBlur="showan(this.value);" onKeyup="showan(this.value);">
								</div>
							...
							if ($question['question_type'] == $this->lang->line('long_answer')) {
								...
								<div class="op">
									...
									echo $qk; ?>">
										<?php
										echo $this->lang->line('auto_check_not_possible'); ?>
									</div>
										...
										foreach ($match_1 as $mk1 => $mval) {
											...
											<tr>
												...
												<td>
													...
													echo $qk; ?>][]" id="answer_value<?php
													echo $qk . '-' . $mk1; ?>" onChange="showan(this.value);">
														<option value="0"><?php
...
<div class="footer_buttons" style="background:#3D4A5D;">
	...
	<button class="btn btn-success btn-lg" id="activeshow" onClick="javascript:check_answer();" style="margin-top:2px;display:none;"><?php
		echo $this->lang->line('show_answer'); ?></button>
	<button class="btn btn-default btn-lg" id="inactiveshow" onClick="" style="margin-top:2px;"><?php
		echo $this->lang->line('show_answer'); ?></button>
