	...
	<div class="row">
		<div class="col-md-12"><br>
					...
					if ($result['attachments'] != '') {
						...
						if ($ext == 'mp4' || $ext == 'ogg') {
							...
							<video width="320" height="240" controls>
								<source src="<?php
								echo base_url('upload/' . $result['attachments']); ?>" type="video/mp4">
								<source src="<?php
								echo base_url('upload/' . $result['attachments']); ?>" type="video/ogg">
								Your browser does not support the video tag.
							</video>
						<?php
						} else { ?>
							<a href="<?php
							echo base_url('upload/' . $result['attachments']); ?>" target="study_material"><?php
			...
			echo site_url('assignment/'); ?>"><?php
				echo $this->lang->line('back'); ?></a> <a href="<?php
			echo site_url('assignment/csv/' . $result['assignment_id']); ?>" class="btn btn-primary"><?php
				echo $this->lang->line('csv_report'); ?></a>
			<hr>
			<?php
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<?php
					echo form_open('assignment/upload_report/' . $result['assignment_id'], array('enctype' => 'multipart/form-data')); ?>
