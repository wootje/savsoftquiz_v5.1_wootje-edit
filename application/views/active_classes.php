<div class="container">
				...
				<div class="panel-body">
					<div class="panel-group" id="accordion">
						...
						if (in_array('All', explode(',', $logged_in['setting']))) {
							?>
							<a href="<?php
							echo site_url('liveclass/add_new'); ?>" class="btn btn-success">Initiate new class</a>
							<?php
						}
						?>
						<a href="<?php
							...
							if ($result == false) {
								...
								foreach ($result as $row) {
									...
									<tr>
										...
										<td data-th="Class Name"><?php
											echo $row['class_name']; ?></td>
										<td data-th="Start Time"><?php
											echo date('Y/m/d H:i:s', $row['initiated_time']); ?></td>
										<td>
											<?php
											...
											if (in_array('All', explode(',', $logged_in['setting']))) {
												?>
												<a href="<?php
												echo site_url('liveclass/attempt/' . $row['class_id']); ?>" class="btn btn-success">Post Content</a>
												<a href="<?php
												echo site_url('liveclass/close_class/' . $row['class_id']); ?>" class="btn btn-danger">Close Class</a>
												<?php
											} else {
												?>
												<a href="<?php
											...
											if (in_array('All', explode(',', $logged_in['setting']))) {
												...
												echo site_url('liveclass/remove_class/' . $row['class_id']); ?>'; }" class="btn btn-danger">Remove</a>
												<a href="<?php
												echo site_url('liveclass/edit_class/' . $row['class_id']); ?>" class="btn btn-info">Edit</a>
												<?php
											}
											?>
										</td>
	...
	<a href="<?php
	echo site_url('liveclass/index/' . $next); ?>" class="btn btn-primary">Next</a>
</div>
