<div class="container">
	...
	<div class="row">
		...
		echo site_url('qbank/new_question_5/' . $nop . '/' . $para); ?>">
			<div class="col-md-8">
				<br>
				<div class="login-panel panel panel-default">
					<div class="panel-body">
						...
						<button class="btn btn-default" type="submit" style="margin-bottom:30px;"><b><?php echo $this->lang->line('submit'); ?></b></button>
						<?php
						if ($para == 1) {
							?>
