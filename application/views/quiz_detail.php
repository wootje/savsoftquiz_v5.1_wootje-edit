<div class="container">
	<h3><?php
		echo $title; ?></h3>
	<div class="row">
		<form method="post" id="quiz_detail" action="<?php
		echo site_url('quiz/validate_quiz/' . $quiz['quid']); ?>">
			<div class="col-md-12">
				<br>
				<div class="login-panel panel panel-default">
					<div class="panel-body">
						...
						<table class="table table-bordered">
							...
							<tr>
								<td><?php
									echo $this->lang->line('start_date'); ?></td>
								<td><?php
									echo date('Y-m-d H:i:s', $quiz['start_date']); ?></td>
							</tr>
							<tr>
								<td><?php
									echo $this->lang->line('end_date'); ?></td>
								<td><?php
									echo date('Y-m-d H:i:s', $quiz['end_date']); ?></td>
							</tr>
							<tr>
								<td><?php
									echo $this->lang->line('duration'); ?></td>
								<td><?php
									echo $quiz['duration']; ?></td>
							</tr>
							<tr>
								<td><?php
									echo $this->lang->line('maximum_attempts'); ?></td>
								<td><?php
									echo $quiz['maximum_attempts']; ?></td>
							</tr>
							<tr>
								<td><?php
									echo $this->lang->line('pass_percentage'); ?></td>
								<td><?php
									echo $quiz['pass_percentage']; ?></td>
							</tr>
							<?php
							$ex = explode(',', $quiz['correct_score']);
							if (count($ex) <= 1) { ?>
								<tr>
									<td><?php
										echo $this->lang->line('correct_score'); ?></td>
									<td><?php
										echo $quiz['correct_score']; ?></td>
								</tr>
								<tr>
									<td><?php
										echo $this->lang->line('incorrect_score'); ?></td>
									<td><?php
										echo $quiz['incorrect_score']; ?></td>
								</tr>
							<?php
							} ?>
							<tr>
								<td><?php
									echo $this->lang->line('select_language'); ?></td>
						...
						if ($quiz['camera_req'] == 1 && $this->config->item('webcam') == true) {
							...
							<div style="color:#ff0000;"><?php
								echo $this->lang->line('camera_instructions'); ?></div>
						...
						<br><br>
							...
							echo base_url(); ?>js/webcamjs/webcam.js"></script>
