<script src="<?php
echo base_url('js/TweenMax.min.js'); ?>"></script>
<style>
	@media print {
		.navbar {
			display: none;
...
echo $this->lang->line('hello'); ?> <?php
			...
			<div class="col-lg-12" style="margin-top:20px;">
				<center>
					...
					if ($result['view_answer'] == '1' || $logged_in['su'] == '1') {
						?>
						<a href="#answers_i" class="btn btn-info" style="margin:10px;"><?php
							echo $this->lang->line('answer_sheet'); ?></a>
						<?php
					}
					?>
					<a href="javascript:print();" class="btn btn-success printbtn" style="margin:10px;"><?php
	...
	<div class="row">
		<div class="col-md-12">
				...
				<div class="panel panel-default">
					...
					<div id="Captured" class="panel-body collapse">
						...
						foreach ($files as $j => $file) {
							$fname = explode('-', $file);
							?>
							<div class="col-lg-3"><img src='<?php
								echo base_url($file); ?>'> <b><?php
			...
			if ($this->config->item('sharethis')) {
				...
				<div class="col-md-12" style="display:none;">
					<h3><?php
						echo $this->lang->line('share_on'); ?></h3>
					<script type="text/javascript" src="//platform-api.sharethis.com/js/sharethis.js#property=<?php
					echo $this->config->item('sharethis_property'); ?>&product=inline-share-buttons"></script>
							...
							<div class="panel-body">
								...
								foreach ($questions as $qk => $question) {
									...
									if ($qk == 0) {
										...
										<div class="col-md-12 " id="q<?php
										echo $qk; ?>" class="" style="margin:10px;padding:10px;<?php
										if ($ind_score[$qk] == '1') { ?>background-color:#71ba5d; color:#ffffff;<?php
		...
		margin-top:6px;padding:14px;border:1px solid #666666;"><b><?php
														echo $qk + 1; ?></b></div>
											</div>
													...
													<div class="op">
														<table>
															<tr>
																<td></td>
																<td><?php
																	echo "<b>" . $this->lang->line('your_answer') . '</b> '; ?></td>
																<td><?php
																	echo "<b>" . $this->lang->line('correct_answer') . '</b> '; ?></td>
															</tr>
															<?php
											...
											<div class="col-md-2 col-sm-2" id="q<?php
											echo $qk; ?>" style="font-size:30px;">
												<?php
												if ($ind_score[$qk] == '1') { ?>
								...
								foreach ($questions as $qk => $question) {
									?>
									<a href="javascript:shoq('<?php
									echo $qk; ?>');" class="btn btn-default"><?php
										echo $qk + 1; ?></a>
									<?php
								}
								?>
								<a href="javascript:shoq('-1');" class="btn btn-default"><?php
									echo $this->lang->line('view_all'); ?></a>
							</div>
						</div>
						<?php
					}
		...
		<input type="hidden" id="evaluate_warning" value="<?php
