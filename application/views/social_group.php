...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<form method="post" id="search" action="<?php
			echo site_url('social_group'); ?>">
				<div class="col-lg-8 col-md-8">
					<input type="text" name="search" value="<?php
					echo $this->input->post('search'); ?>" class="form-control" placeholder="<?php
				...
				<div class="panel panel-default">
					...
					<div class="panel-footer">
						...
						<?php
							...
							?>
							<a href="<?php
							echo site_url('social_group/unjoin/' . $val['sg_id']); ?>" class="btn btn-defult"> <?php
								echo $this->lang->line('unjoin'); ?></a>
						<?php
						} else {
							?>
							<a href="#" class="btn btn-defult"><?php
								echo $this->lang->line('urowner'); ?></a>
							<?php
						}
						$acp = explode(',', $logged_in['social_group']);
						if (in_array('Invite', $acp)) {
							?>
							<a href="<?php
							echo site_url('social_group/view/' . $val['sg_id'] . '/invite'); ?>" class="btn btn-primary"> <?php
						...
						if (in_array('Add_other', $acp)) {
							?>
							<a href="<?php
							echo site_url('social_group/view/' . $val['sg_id'] . '/adduser'); ?>" class="btn btn-primary"> <?php
					...
					<div class="panel-footer">
						<?php
						echo $val['no_member']; ?> <?php
						echo $this->lang->line('members'); ?>
						...
						if (in_array('Edit', $acp)) {
							if ($val['created_by'] == $logged_in['uid']) { ?>
								<a href="<?php
								echo site_url('social_group/edit_group/' . $val['sg_id']); ?>"> <img src="<?php
						...
						if (in_array('Remove', $acp)) {
							if ($val['created_by'] == $logged_in['uid']) {
								?>
								<a href="javascript:remove_entry('social_group/remove_group/<?php
								echo $val['sg_id']; ?>');"><img src="<?php
	...
	<div class="col-lg-12">
		...
		<a href="<?php
		echo site_url('social_group/index/' . $next); ?>" class="btn btn-primary"><?php
