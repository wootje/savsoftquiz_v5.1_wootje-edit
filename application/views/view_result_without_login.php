...
<div class="container">
	...
	<div class="row" style="border-bottom:1px solid #dddddd;">
		<div class="container">
			...
			<div class="col-md-10">
				<a href="<?php
				echo base_url(); ?>"><img src="<?php
					echo base_url('images/logo.png'); ?>"></a>
				<?php
				echo $this->lang->line('login_tagline'); ?>
			</div>
			<div class="col-md-1"></div>
		</div>
	</div>
...
echo $this->lang->line('hello'); ?> <?php
			...
			if ($this->session->userdata('logged_in')) {
				...
				<div class="col-lg-12" style="margin-top:20px;">
					<center>
						<?php
						echo str_replace('{base_url}', base_url(), $this->lang->line('login_required3')); ?>
					</center>
				</div>
				<?php
			}
...
</div></div><input type="hidden" id="evaluate_warning" value="<?php
