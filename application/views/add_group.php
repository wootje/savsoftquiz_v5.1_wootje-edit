<div class="container">
	...
	<div class="row">
		...
		echo site_url('user/add_new_group'); ?>">
			<div class="col-md-8">
				<br>
				<div class="login-panel panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<p class="alert alert-warning">Free version doesn't support payment gateway.
								<br>Create free group (with zero price) or <a href="<?php
								echo site_url('payment_gateway'); ?>">Upgrade version</a>
						</div>
						<div class="form-group">
							<label for="inputEmail"><?php
