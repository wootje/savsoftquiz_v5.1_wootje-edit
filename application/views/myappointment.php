<div class="container">
		...
		<div class="col-md-12">
			...
			<table class="table table-bordered">
				<tr>
					<th>#</th>
					<th><?php
						echo $this->lang->line('requested_by'); ?></th>
					<th><?php
						echo $this->lang->line('appointed_to'); ?> </th>
					<th><?php
						echo $this->lang->line('appointment_time'); ?></th>
					<th><?php
	...
	<a href="<?php
	echo site_url('appointment/myappointment/' . $back); ?>" class="btn btn-primary"><?php
		echo $this->lang->line('back'); ?></a> &nbsp;&nbsp;
	<?php
	$next = $limit + ($this->config->item('number_of_rows')); ?>
	<a href="<?php
	echo site_url('appointment/myappointment/' . $next); ?>" class="btn btn-primary"><?php
