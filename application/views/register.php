	...
	<body class="bg-gradient-primary">
								<div id="loginwindow">
									<div id="logincontent">
										...
										<form class="user" method="post" action="<?php echo site_url('login/insert_user/');?>">
											<?php 
													...
													<div class="form-group">
														...
														<select class="form-control" name="gid" id="gid"> 
															...
															foreach($group_list as $key => $val){ ?>
																<option value="<?php echo $val['gid'];?>" <?php if($val['gid']==$gid){ echo 'selected'; } ?>> 
																	<?php echo $val['group_name'];?> ( <?php echo $this->lang->line('price_');?>: <?php echo $val['price'];?>) 
																</option> 
																<?php 
															} 
															?>
