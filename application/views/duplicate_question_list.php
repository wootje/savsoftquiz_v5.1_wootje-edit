<h3><?php
	echo $this->lang->line('duplicate_question_found'); ?></h3><?php
foreach ($result as $key => $val) {
	...
	<p>
		<label> <a href="<?php
			echo site_url('qbank/edit_question_' . $qn . '/' . $val['qid']); ?>" target="edit_question">
				<?php
				echo substr(strip_tags($val['question']), 0, 40); ?></a></label> <br>
		<?php
		echo $val['question_type']; ?> <br> <span style="font-size:12px;"><?php
			echo $val['category_name']; ?> / <?php
			echo $val['level_name']; ?></span>
	</p>
	<?php
}
?>  
