					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
								...
								echo site_url('user'); ?>">
									<?php
									echo $this->lang->line('no_registered_user'); ?>
								</a>
							</div>
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
								...
								echo site_url('qbank'); ?>">
									<?php
									echo $this->lang->line('no_questions_qbank'); ?>
								</a>
							</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php
								echo $num_qbank; ?></div>
					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
								...
								echo site_url('quiz'); ?>">
									<?php
									echo $this->lang->line('no_registered_quiz'); ?>
								</a>
							</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php
								echo $num_quiz; ?></div>
							...
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
										...
										echo site_url('user'); ?>">
											<?php
											echo $this->lang->line('inactive'); ?><?php
											echo $this->lang->line('users'); ?>
										</a>
									</div>
									<div class="h5 mb-0 font-weight-bold text-gray-800"><?php
										echo $inactive_users; ?></div>
								</div>
								<div class="col-auto">
			...
			<div class="card  shadow  py-2" style="margin-top:20px;">
				<div class="card-heading" style="padding:5px;">
					<h6 class="m-0 font-weight-bold text-primary">
						<?php
						echo $this->lang->line('recently_registered'); ?>
					</h6>
				</div>
				<div class="card-body table-responsive">
					<table class="table table-striped valign-middle">
						...
						<tr>
							<th><?php
								echo $this->lang->line('email'); ?></th>
							<th class="text-xs-right"><?php
								echo $this->lang->line('full_name'); ?></th>
							<th class="text-xs-right"><?php
								echo $this->lang->line('group_name'); ?></th>
							<th class="text-xs-right"><?php
								echo $this->lang->line('contact_no'); ?></th>
							<th></th>
						</tr>
						</thead>
						<tbody>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary"><?php
						...
						if ($cal < 0) {
							?>
							<small class="font-weight-light text-muted" style="font-size:16px;color:#ff0000;" title="<?php
							echo $this->lang->line('growth_lath_month'); ?>">
								<?php
								echo $cal; ?>% <i class="fa fa-arrow-down"></i> </small>
							<?php
						} else {
							?>
							<small class="font-weight-light text-muted" style="font-size:16px;color:#72B159;" title="<?php
							echo $this->lang->line('growth_lath_month'); ?>">
								<?php
								echo $cal; ?>% <i class="fa fa-arrow-up"></i> </small>
							<?php
						}
						?>
						<?php
						echo $this->lang->line('past_days'); ?>
					</h6>
				</div>
				<!-- Card Body -->
				<div class="card-body">
					<div class="font-size-34"><small class="font-weight-light text-muted"><?php
						...
						<small class="font-weight-light text-muted"><?php
							echo $this->lang->line('this_year'); ?> </small>
					</div>
			...
			<div class="panel">
				<div class="panel-heading">
					<div class="panel-title"><?php
						echo $this->lang->line('recent_sub'); ?></div>
				</div>
				<?php
				if (count($payments) == 0) {
					?>
				...
				foreach ($payments as $key => $val) {
					...
					echo $colorcode[$i]; ?>" style="margin:5px;">
						<a href="<?php
						echo site_url('user/edit_user/' . $val['uid']); ?>">   <?php
						...
						echo $colorcode[$i]; ?>">
							<?php
							echo $this->config->item(strtolower($val['payment_gateway']) . '_currency_prefix'); ?><?php
							echo $val['amount']; ?><?php
							echo $this->config->item(strtolower($val['payment_gateway']) . '_currency_sufix'); ?>
						</button>
					</div>
					<?php
					if ($i >= 4) {
