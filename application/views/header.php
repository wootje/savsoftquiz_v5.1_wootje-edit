...
<head>
	...
	<!-- custom css -->
	<link href="<?php
	echo base_url('css/style.css?q=' . time()); ?>" rel="stylesheet">
	...
	<script src="<?php
	echo base_url(); ?>vendor/jquery/jquery.min.js"></script>
	<script src="<?php
	echo base_url(); ?>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
	<!-- Core plugin JavaScript-->
	<script src="<?php
	echo base_url(); ?>vendor/jquery-easing/jquery.easing.min.js"></script>
	<!-- Custom scripts for all pages-->
	<script src="<?php
	echo base_url(); ?>js/sb-admin-2.min.js"></script>
	<!-- Page level plugins -->
	<script src="<?php
	echo base_url(); ?>vendor/chart.js/Chart.min.js"></script>
	<script>
	...
	if (($this->uri->segment(1) . '/' . $this->uri->segment(2)) != 'quiz/attempt') {
		...
		<!-- custom javascript -->
		<script src="<?php
		echo base_url('js/basic.js?q=' . time()); ?>"></script>
		<?php
	}
	?>
	<!-- firebase messaging menifest.json -->
	<link rel="manifest" href="<?php
	echo base_url('js/manifest.json'); ?>">
</head>
<body id="page-top">
<?php
...
<div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		...
		<center><span style="color:#ffffff;"><?php
				echo $hres[1]['setting_value']; ?> </span></center>
		<!-- Divider -->
		...
		if (in_array('All', explode(',', $logged_in['setting']))) {
			...
			<li class="nav-item active">
				...
				echo site_url('dashboard'); ?>"> <i class="fas fa-fw fa-tachometer-alt"></i> <span><?php
						echo $this->lang->line('dashboard'); ?></span></a>
			</li>
		<?php
		} ?>
		<!-- Divider -->
  ...
  -->
		...
		if (in_array('List_all', explode(',', $logged_in['users']))) {
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
					<i class="fas fa-fw fa-users"></i> <span><?php
						echo $this->lang->line('users'); ?></span> </a>
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						if (in_array('Add', explode(',', $logged_in['users']))) {
							...
							echo site_url('user/new_user'); ?>"><?php
								echo $this->lang->line('add_new'); ?></a>
						<?php
						} ?>
						<?php
						if (in_array('List', explode(',', $logged_in['users'])) || in_array('List_all', explode(',', $logged_in['users']))) {
							?>
							<a class="collapse-item" href="<?php
							echo site_url('user'); ?>"><?php
								echo $this->lang->line('users'); ?><?php
								echo $this->lang->line('list'); ?></a>
						<?php
						} ?>
						<?php
						if (in_array('List_all', explode(',', $logged_in['appointment']))) { ?>
							<a class="collapse-item" href="<?php
							echo site_url('appointment/myappointment/'); ?>"><?php
		...
		if (in_array('List', explode(',', $logged_in['questions'])) || in_array('List_all', explode(',', $logged_in['questions']))) {
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
					<i class="fas fa-fw fa-university"></i> <span><?php
						echo $this->lang->line('qbank'); ?></span> </a>
				<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						if (in_array('Add', explode(',', $logged_in['questions']))) {
							?>
							<a class="collapse-item" href="<?php
							echo site_url('qbank/pre_new_question'); ?>"><?php
								echo $this->lang->line('add_new'); ?></a>
							<?php
						}
						if (in_array('List', explode(',', $logged_in['questions'])) || in_array('List_all', explode(',', $logged_in['questions']))) {
							?>
							<a class="collapse-item" href="<?php
							echo site_url('qbank'); ?>"><?php
								echo $this->lang->line('question'); ?><?php
								echo $this->lang->line('list'); ?></a>
							<?php
						}
						?>
		...
		if (in_array('List', explode(',', $logged_in['quiz'])) || in_array('List_all', explode(',', $logged_in['quiz']))) {
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseQuiz" aria-expanded="true" aria-controls="collapseQuiz">
					<i class="fas fa-fw fa-chalkboard-teacher"></i> <span><?php
						echo $this->lang->line('quiz'); ?> </span> </a>
				<div id="collapseQuiz" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						if (in_array('Add', explode(',', $logged_in['quiz']))) {
							?>
							<a class="collapse-item" href="<?php
							echo site_url('quiz/add_new'); ?>"><?php
								echo $this->lang->line('add_new'); ?></a>
							<?php
						}
						if (in_array('List', explode(',', $logged_in['quiz'])) || in_array('List_all', explode(',', $logged_in['quiz']))) {
		...
		if (in_array('List', explode(',', $logged_in['results'])) || in_array('List_all', explode(',', $logged_in['results']))) {
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseResult" aria-expanded="true" aria-controls="collapseResult">
					<i class="fas fa-fw fa-folder"></i> <span><?php
					echo $this->lang->line('result'); ?></a></span></a>
				<div id="collapseResult" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?php
						echo site_url('result'); ?>"><?php
							echo $this->lang->line('result'); ?><?php
							echo $this->lang->line('list'); ?></a>
					</div>
				</div>
			</li>
		...
		if (in_array('List', $acp)) {
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseStudy" aria-expanded="true" aria-controls="collapseStudy">
					<i class="fas fa-fw fa-book"></i> <span><?php
						echo $this->lang->line('study_material'); ?></span> </a>
				<div id="collapseStudy" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?php
						echo site_url('study_material'); ?>"><?php
							echo $this->lang->line('study_material'); ?></a>
					</div>
				</div>
			</li>
			<?php
		...
		if (in_array('All', explode(',', $logged_in['setting']))) {
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSetting" aria-expanded="true" aria-controls="collapseSetting">
					<i class="fas fa-fw fa-cog"></i> <span><?php
						echo $this->lang->line('setting'); ?></span> </a>
				<div id="collapseSetting" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?php
						echo site_url('setting'); ?>"><?php
							echo $this->lang->line('setting'); ?></a> <a class="collapse-item" href="<?php
						echo site_url('notification'); ?>"><?php
							echo $this->lang->line('notification'); ?></a> <a class="collapse-item" href="<?php
						echo site_url('user/group_list'); ?>"><?php
							echo $this->lang->line('group_list'); ?></a> <a class="collapse-item" href="<?php
						echo site_url('qbank/category_list'); ?>"><?php
							echo $this->lang->line('category_list'); ?></a> <a class="collapse-item" href="<?php
						...
						echo site_url('payment_gateway'); ?>"><?php
							echo $this->lang->line('payment_history'); ?></a> <a class="collapse-item" href="<?php
						echo site_url('payment_gateway'); ?>"><?php
							echo $this->lang->line('advertisment'); ?></a>
					</div>
				</div>
			</li>
			<?php
		...
		if (!in_array('List_all', explode(',', $logged_in['quiz']))) {
			?>
			<a href="<?php
			echo site_url('user/switch_group'); ?>" class="btn btn-danger" style="border-radius:0px;"><?php
				echo $this->lang->line('change_group'); ?></a>
			<?php
		}
		?>
	...
	join savsoft_users on savsoft_users.uid=appointment_request.request_by 
	 where appointment_request.to_id='$uid' and appointment_request.appointment_status='Pending' ");
	  ...
	  where (savsoft_notification.uid='$uid' OR savsoft_notification.uid='0') AND (savsoft_notification.viewed='0')  ");
					...
					<li class="nav-item dropdown no-arrow mx-1">
						<a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							...
							<span class="badge badge-danger badge-counter"><?php
								echo count($invitations) + count($notifications); ?></span> </a>
						<!-- Dropdown - Alerts -->
						<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
							...
							if (count($invitations) >= 1) {
								...
								echo site_url('appointment/myappointment/'); ?>">
									<div>
										<div class="small text-gray-500"><?php
											echo date('d M Y', time()); ?></div>
										<span class="font-weight-bold">There are <?php
											echo count($invitations); ?> pending appointments</span>
									</div>
								</a>
								<?php
							}
							foreach ($notifications as $k => $notification) {
								?>
								<a class="dropdown-item d-flex align-items-center" href="<?php
								echo site_url('notification'); ?>">
									<div>
										<div class="small text-gray-500"><?php
											echo $notification['notification_date']; ?></div>
										<span class="font-weight-bold"><?php
											echo $notification['title']; ?> </span>
									</div>
								</a>
								<?php
							}
				...
				<?php
				echo $logged_in['first_name'] . ' ' . $logged_in['last_name']; ?> </span>
							<!-- <img class="img-profile rounded-circle" src=""> -->
						</a>
						<!-- Dropdown - User Information -->
						<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
							<a class="dropdown-item" href="<?php
							echo site_url('user/edit_user/' . $logged_in['uid']); ?>">
								<i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
								<?php
								echo $this->lang->line('myaccount'); ?>
							</a>
							<?php
			...
			<div class="container-fluid">
				<center><?php
					...
					?></center>
				<?php
				if ($this->session->flashdata('message_header')) {
