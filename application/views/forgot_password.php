						...
						<div class="col-lg-6" style="max-width:30em;">
							<div class="p-5">
								...
								if ($this->session->flashdata('message')) { ?>
									...
									echo site_url('login/forgot'); ?>">
										<h4 class="form-signin-heading"><?php
											echo $this->lang->line('send_new_password'); ?></h4>
										<div class="form-group">
											<label for="inputEmail" style=""><?php
												echo $this->lang->line('email_linked_account'); ?></label>
										...
										<div class="form-group">
											<button class="btn btn-lg btn-primary btn-block btn-round btn-left" type="submit"><?php
												echo $this->lang->line('send_new_password'); ?></button>
										</div>
									</form>
									<?php
								}
