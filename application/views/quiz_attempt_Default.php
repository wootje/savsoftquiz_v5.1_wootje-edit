...
// how to show here if another question language is selected other than english as it was available ther in edit question in different language https://github.com/craziks-creator/savasoft_v5/blob/9b77891024076b14c687760091bc12a80015be1f/application/views/edit_question_1.php#L98C127-L98C127
						...
						<div class="option_container">
							...
							if ($question['question_type'] == $this->lang->line('short_answer')) {
								...
								<div class="op">
									...
									<input type="text" style="margin-left:10px;padding-left:5px;" name="answer[<?php
									echo $qk; ?>][]" value="<?php
		...
		<div class="col-md-3" style="min-height:84%;padding:5px;color:#212121;">
			<div style="margin-left:5px;margin-top:15px;"> <?php
				echo $this->lang->line('questions'); ?></div>
...
<div class="footer_buttons" style="background:#3D4A5D;">
	<button class="btn btn-warning" onClick="javascript:review_later();" style="margin-top:2px;"><?php
		echo $this->lang->line('review_later'); ?></button>
