<div class="container">
	...
	<div class="row">
		...
		echo site_url('notification/send_notification'); ?>">
			<div class="col-md-8">
				<br>
				<div class="login-panel panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label for="inputEmail"><?php
								echo $this->lang->line('message'); ?></label>
							<input type="text" required name="message" class="form-control">
						</div>
						<div class="form-group">
							<label for="inputEmail"><?php
								echo $this->lang->line('click_action'); ?></label>
							<input type="text" required name="click_action" value="<?php
							echo base_url(); ?>" class="form-control">
						</div>
						<?php
						if ($tuid == '0') {
							?>
							<input type="hidden" required name="notification_to[]" value="<?php
							echo '/topics/' . $this->config->item('firebase_topic'); ?>">
							<?php
							...
							<input type="hidden" required name="notification_to[]" value="<?php
							echo $nuser['android_token']; ?>">
							<input type="hidden" required name="uid" value="<?php
							echo $tuid; ?>">
							<?php
						}
						?>
