<div class="container">
	...
	echo site_url('liveclass/edit_class/' . $class_id); ?>">
		<a href="<?php
		echo site_url('liveclass'); ?>" class="btn btn-danger">Back</a>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type='text' class="form-control" name='class_name' value="<?php
								...
								<div class="form-group">
									...
									echo date("Y/m/d H:i:s", $result['initiated_time']); ?>">
								</div>
								<div class="form-group">
									<label>Assign to Groups:</label><br>
									<?php
									$group_counter = 1;
									foreach ($groups as $key => $group) { ?><?php
										echo $group['group_name']; ?>  &nbsp;
										<input type="checkbox" name="assigned_groups[]" value="<?php
										echo $group['gid']; ?>" <?php
										if (in_array($group['gid'], $assigned_gids)) {
											echo "checked";
										} ?> > &nbsp; &nbsp;&nbsp;
										<?php
