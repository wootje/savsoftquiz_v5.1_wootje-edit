...
Class Qbank_model extends CI_Model
{
	...
	{
		$userdata = array('category_name' => $this->input->post('category_name'),);
	...
	{
		$userdata = array('level_name' => $this->input->post('level_name'),);
					...
					if ($prevtype == "0") {
						for ($i = 1; $i <= 10; $i++) {
							if ($singlequestion[$optionkeycounter] != "") {
								...
								$insert_options = array("q_option1" => $singlequestion[$optionkeycounter],);
